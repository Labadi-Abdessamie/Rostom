                                ...
                                <div class="widget-rounded-circle card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$totalVendors}}</span></h3>
                                ...
                                <div class="widget-rounded-circle card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$totalProducts}}</span></h3>
                                ...
                                <div class="widget-rounded-circle card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="text-end">
                                                    <h3 class="text-dark mt-1"><span data-plugin="counterup">{{$totalClients}}</span></h3>
                                            ...
                                            <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                                ...
                                                <tbody>
                                                    @foreach($magasins->sortByDesc('rate') as $magasin)
                                                        <tr>
                                                            <td style="width: 36px;">
                                                                <img src="{{ $magasin->picture }}" alt="magasin-img" class="rounded-circle avatar-sm" />
                                                            </td>
                                                            <td>
        ...
        <tbody>
            @foreach($latestOrders->forPage(request()->get('page', 1), 5) as $order)
                <tr>
                    <td>#{{ $order->id }}</td>
                    <td>
                        <h5 class="m-0 fw-normal">{{ $order->customer->name ?? 'N/A' }}</h5>
                    </td>
                    <td>
                        <h5 class="m-0 fw-normal">{{ $order->vendor->name ?? 'N/A' }}</h5>
                    </td>
                    <td>
                        <span class="badge 
