                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.update_banner', $banner->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($banner->image)
                                    <img src="{{ asset('storage/' . $banner->image) }}" alt="Current Banner" class="img-thumbnail mb-2" width="200">
                                @else
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="page" class="form-control" value="{{ old('page', $banner->page) }}" required>
                            </div>

                            <!-- Position -->
                            <div class="mb-3">
                                <label for="position" class="form-label">Position</label>
                                <input type="text" name="position" class="form-control" value="{{ old('position', $banner->position) }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="type" class="form-select" required>
                                    <option value="normal" {{ $banner->type === 'normal' ? 'selected' : '' }}>Normal</option>
                                    <option value="cooldown" {{ $banner->type === 'cooldown' ? 'selected' : '' }}>Cooldown</option>
                                </select>
                            </div>
