                                ...
                                <table class="table table-bordered table-centered mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><img src="assets/images/products/product-1.png" alt="product-img"
                                                    height="32"></td>
                                            <td>1</td>
                                            <td>$39</td>
                                            <td>$39</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="assets/images/products/product-5.png" alt="product-img"
                                                    height="32"></td>
                                            <td>2</td>
                                            <td>$46</td>
                                            <td>$92</td>
                                        ...
                                        <tr>
                                            <th scope="row">Red Hoodie for men</th>
                                            <td><img src="assets/images/products/product-3.png" alt="product-img"
                                                    height="32"></td>
                                            <td>1</td>
                                            <td>$46</td>
                                            <td>$46</td>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-2"><span class="fw-semibold me-2">Address:</span> 3559 Roosevelt Wilson Lane San
                                Bernardino, CA 92405</p>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    ...
                                    <p class="mb-2"><span class="fw-semibold me-2">Provider:</span> Visa ending in 2851
                                    </p>
