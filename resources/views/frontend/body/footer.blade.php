            ...
            <div class="row justify-content-between">
                <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                    <div class="wsus__footer_content">
                        ...
                        <a class="action" href="callto:+213770707070"><i class="fas fa-phone-alt"></i>
                            +213770707070</a>
                        <a class="action" href="support@atlas-mall.com"><i class="far fa-envelope"></i>
                            support@atlas-mall.com</a>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="wsus__copyright d-flex justify-content-center">
                            <p>Copyright © 2023 - <script>document.write(new Date().getFullYear())</script> Atlas Mall. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
