                                        ...
                                        <div class="wsus__product_topbar_left">
                                            ...
                                            <form method="GET" id="sortForm">
                                                ...
                                                <select class="select_2" name="sort"
                                                    ...
                                                    <option value="rating"
                                                        {{ request('sort') == 'rating' ? 'selected' : '' }}>Sort
                                                        by Rating</option>
                                                    <option value="latest"
                                                    ...
                                                    <option value="high_low"
                                                        {{ request('sort') == 'high_low' ? 'selected' : '' }}>High to Low
                                                    </option>
                                                </select>
                                            </form>
                                        </div>
                                        <div class="wsus__topbar_select">
                                            <form method="GET" id="stateForm">
                                                ...
                                                <select class="select_2" name="number"
                                                    ...
                                                    <option value="12"
                                                        {{ request('number') == '12' ? 'selected' : '' }}>Show
                                                        12</option>
                                                    <option value="15"
                                                        {{ request('number') == '15' ? 'selected' : '' }}>Show
                                                        15</option>
                                                    <option value="18"
                                                        {{ request('number') == '18' ? 'selected' : '' }}>Show
                                                        18</option>
                                                    <option value="21"
                                                        {{ request('number') == '21' ? 'selected' : '' }}>Show
                                                        21</option>
                                                </select>
                                            </form>
                                        </div>
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="wsus__product_item wsus__list_view">
                                                        ...
                                                        <div class="wsus__product_details">
                                                            ...
                                                            <p class="list_description">{{ $product->short_description }}
                                                            </p>
                                                            <ul class="wsus__single_pro_icon">
