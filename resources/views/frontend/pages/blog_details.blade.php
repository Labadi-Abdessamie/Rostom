                ...
                <div class="col-xxl-9 col-xl-8 col-lg-8">
                    <div class="wsus__main_blog">
                        <div class="wsus__main_blog_img">
                            <img src="{{asset('frontend/images/blog_details.jpg')}}" alt="blog" class="img-fluid w-100">
                        </div>
                                    ...
                                    <div class="wsus__single_blog wsus__single_blog_2">
                                        ...
                                        <div class="wsus__blog_text">
                                            ...
                                            <div class="wsus__blog_text_center">
                                                <a href="{{ route('frontend.blog_details') }}">New found the women’s shirt for summer
                                                    season</a>
                                ...
                                <div class="col-xl-3">
                                    <div class="wsus__single_blog wsus__single_blog_2">
                                        ...
                                        <div class="wsus__blog_text">
                                            ...
                                            <div class="wsus__blog_text_center">
                                                <a href="{{ route('frontend.blog_details') }}">Fusce lacinia arcuet nulla menasious</a>
                                                <p class="date">nov 04 2021</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="wsus__single_blog wsus__single_blog_2">
                                        ...
                                        <div class="wsus__blog_text">
                                            ...
                                            <div class="wsus__blog_text_center">
                                                <a href="{{ route('frontend.blog_details') }}">found the men’s shirt for summer season</a>
                                                <p class="date">nov 04 2021</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="wsus__single_blog wsus__single_blog_2">
                                        ...
                                        <div class="wsus__blog_text">
                                            ...
                                            <div class="wsus__blog_text_center">
                                                <a href="{{ route('frontend.blog_details') }}">winter collection for women’s</a>
                                                <p class="date">nov 04 2021</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3">
                                    <div class="wsus__single_blog wsus__single_blog_2">
                                        ...
                                        <div class="wsus__blog_text">
                                            ...
                                            <div class="wsus__blog_text_center">
                                                <a href="{{ route('frontend.blog_details') }}">Comes a cool blog post with Images</a>
                                                <p class="date">nov 04 2021</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="wsus__comment_area">
                            ...
                            <div class="wsus__main_comment wsus__com_replay">
                                <div class="wsus__comment_img">
                                    <img src="{{asset('frontend/images/client_img_3.jpg')}}" alt="user" class="img-fluid w-100">
                                </div>
                                <div class="wsus__comment_text replay">
                        ...
                        <div class="wsus__blog_post">
                            ...
                            <div class="wsus__blog_post_single">
                                <a href="#" class="wsus__blog_post_img">
                                    <img src="{{asset('frontend/images/location_1.jpg')}}" alt="blog" class="imgofluid w-100">
                                </a>
                            ...
                            <div class="wsus__blog_post_single">
                                <a href="#" class="wsus__blog_post_img">
                                    <img src="{{asset('frontend/images/location_2.jpg')}}" alt="blog" class="imgofluid w-100">
                                </a>
                                <div class="wsus__blog_post_text">
                                    <a href="#">One Thing Separates Creators</a>
                                    <p> <span>Jul 29 2021 </span> 2 Comment </p>
                            ...
                            <div class="wsus__blog_post_single">
                                <a href="#" class="wsus__blog_post_img">
                                    <img src="{{asset('frontend/images/location_3.jpg')}}" alt="blog" class="imgofluid w-100">
                                </a>
                                <div class="wsus__blog_post_text">
                                    <a href="#">One Thing Separates Creators</a>
                                    <p> <span>Jul 29 2021 </span> 2 Comment </p>
                            ...
                            <div class="wsus__blog_post_single">
                                <a href="#" class="wsus__blog_post_img">
                                    <img src="{{asset('frontend/images/location_4.jpg')}}" alt="blog" class="imgofluid w-100">
                                </a>
                                <div class="wsus__blog_post_text">
                                    <a href="#">One Thing Separates Creators</a>
                                    <p> <span>Jul 29 2021 </span> 2 Comment </p>
