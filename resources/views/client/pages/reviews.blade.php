                                ...
                                <div class="wsus__dashboard_review_item">
                                    ...
                                    <div class="wsus__dash_rev_text">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{ route('client.review.delete', $review->id) }}"
                                                    onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this review?')) document.getElementById('delete-review-{{ $review->id }}').submit();">
                                        ...
                                        <div class="accordion accordion-flush" id="accordionFlush{{ $review->id }}">
                                            <div class="accordion-item">
                                                <div id="editReview{{ $review->id }}"
                                                    class="accordion-collapse collapse">
                                                    <div class="accordion-body">
                                                        <form action="{{ route('client.review.update', $review->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
