                            ...
                            <div class="col-xl-6">
                                <div class="wsus__dash_add_single">
                                    ...
                                    <ul>
                                        ...
                                        <li><span>Principal Address:</span> {{ $address->principalAddress ? 'Yes' : 'No' }}
                                        </li>
                                    </ul>
                                    <div class="wsus__address_btn">
                                        <a href="{{ route('client.address.edit', $address->id) }}"
                                            class="edit d-flex align-items-center justify-content-center">
                                        ...
                                        <form action="{{ route('client.address.delete', $address->id) }}" method="POST"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="del btn btn-danger btn-sm"
