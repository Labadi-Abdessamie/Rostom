                        ...
                        @foreach($addresses as $address)
                            <div class="col-xl-6">
                                <div class="wsus__dash_add_single">
                                    <h4>Billing Address <span>{{ $address->type }}</span></h4>
                                    <ul>
                                        ...
                                        <li><span>Company:</span> {{ $address->company ?? 'N/A' }}</li>
                                    ...
                                    <div class="wsus__address_btn">
                                        ...
                                        <form action="{{ route('client.address.destroy', $address->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
