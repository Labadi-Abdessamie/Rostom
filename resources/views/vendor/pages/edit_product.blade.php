    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12 col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('vendor.update_product', $product->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity" id="quantity" class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity', $product->actual_quantity) }}" required>
                                @error('quantity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="principalImage" id="principalImage" class="form-control @error('principalImage') is-invalid @enderror">
                            ...
                            @if ($product->principalImage)
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('storage/' . $product->principalImage) }}" alt="Current Product Image" width="150">
                                </div>
                            @endif
