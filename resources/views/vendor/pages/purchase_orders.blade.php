...
<section class="section">
    ...
    <div class="section-body">
                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <ul class="nav nav-pills" id="orders-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#payed-orders" id="payed-orders-tab" data-bs-toggle="pill" data-bs-target="#payed-orders" role="tab" aria-controls="payed-orders" aria-selected="true">Payed <span class="badge badge-primary">{{ $payedOrders->count() }}</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#not-fully-payed-orders" id="not-fully-payed-orders-tab" data-bs-toggle="pill" data-bs-target="#not-fully-payed-orders" role="tab" aria-controls="not-fully-payed-orders" aria-selected="false">Not Fully Payed</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#debt-orders" id="debt-orders-tab" data-bs-toggle="pill" data-bs-target="#debt-orders" role="tab" aria-controls="debt-orders" aria-selected="false">Debt</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="tab-content" id="orders-tabContent">
                                    ...
                                    <table class="table table-striped" id="table-1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{ route('vendor.purchase_orders.show', $order->id) }}" class="btn btn-info btn-sm mr-2">Detail</a>
                                                    <form action="{{ route('vendor.purchase_orders.delete', $order->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                        @csrf
                                                        @method('DELETE')
            ...
            <div class="tab-pane fade" id="not-fully-payed-orders" role="tabpanel" aria-labelledby="not-fully-payed-orders-tab">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
