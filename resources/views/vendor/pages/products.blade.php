                                ...
                                <tbody>
                                    @forelse ($products as $product)
                                        <tr>
                                            ...
                                            <td>{{ $product->name }}</td>
                                            <td>DZ {{ number_format($product->price, 2) }}</td>
                                            <td class="text-center">{{ $product->actual_quantity ?? 0 }}</td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">{{ $product->rate_count ?? 0 }}</td>
                                            <td class="text-center">
                                    ...
                                    <tbody>
                                        @forelse ($products as $product)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @if ($product->principalImage)
                                                        <img src="{{ asset('storage/' . $product->principalImage) }}"
                                                ...
                                                <td class="text-center">{{ $product->order_items_sum_quantity ?? 0 }}</td>
                                                <td class="text-center">
